...
#undef ON_ALL_ACTIONS
    ...
    void TerminalPage::_LazyLoadWinGetFactory()
    {
        if (!_wingetFactory)
        {
            return;
        ...
        {
            _wingetFactory = WindowsPackageManagerManualActivationFactory{};
        }
        _wingetFactory = WindowsPackageManagerDefaultFactory{};
    }
    ...
    {
        FindPackagesOptions findPackagesOptions = _wingetFactory.CreateFindPackagesOptions();
        PackageMatchFilter filter = _wingetFactory.CreatePackageMatchFilter();
        filter.Field(field);
    ...
    Windows::Foundation::IAsyncOperation<IVectorView<MatchResult>> TerminalPage::_FindPackageAsync(hstring query)
    {
        ...
        PackageManager packageManager = _wingetFactory.CreatePackageManager();
